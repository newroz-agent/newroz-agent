# Streaming LLM Response Support for Newroz Agent
...
```
NEWROZ_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("NEWROZ_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `newroz_cli/config.py` | 1 | +streaming config defaults |
