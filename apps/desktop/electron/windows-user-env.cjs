...
// even though a fresh shell — and the Newroz CLI — sees it immediately. The
// desktop's NEWROZ_HOME resolution relies on process.env, so that stale-snapshot
...
//       NEWROZ_HOME    REG_SZ    F:\Newroz\data
//
