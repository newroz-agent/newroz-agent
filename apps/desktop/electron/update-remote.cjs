 ...
 *
 * A public install can end up with `origin=git@github.com:newroz-agent/newroz-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/newroz-agent/newroz-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/nousresearch/newroz-agent'
