...
export const en: Translations = {
  ...
  boot: {
    ready: 'Newroz Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Newroz settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingNewrozDesktop: 'Starting Newroz Desktop…'
    },
    errors: {
      backgroundExited: 'Newroz background process exited.',
      backgroundExitedDuringStartup: 'Newroz background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Newroz backend is older than this desktop build and may not work correctly. Update to align them.',
    updateNewroz: 'Update Newroz',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Newroz Desktop.',
    ...
    native: {
      ...
      inputBody: 'Newroz is waiting for your response.',
      turnDoneTitle: 'Newroz finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Newroz defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Newroz is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Newroz asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Newroz was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Newroz follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Newroz is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Newroz, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Newroz checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Newroz configuration...',
    ...
    gateway: {
      ...
      intro:
        'Newroz Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Newroz backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset NEWROZ_DESKTOP_REMOTE_URL and NEWROZ_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Newroz backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Newroz backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /newroz.',
      ...
      restartingMessage: 'Newroz Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Newroz ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Newroz runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via newroz curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Newroz builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Newroz to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Newroz to generate pets.',
      backgroundHint: 'You can close this — Newroz will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Newroz desktop' },
    ...
    newrozActiveSessions: (version, count) => `Newroz ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@newroz:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Newroz environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Newroz will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Newroz backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Newroz. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Newroz...',
    placeholderReconnecting: 'Reconnecting to Newroz…',
    ...
    attachUrlDesc: 'Newroz will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Newroz to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Newroz…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Newroz…',
    ...
    unsupportedMessage: 'This version of Newroz can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Newroz from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Newroz will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Newroz desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Newroz updater takes over in its own window and reopens Newroz automatically when it’s done. Please don’t reopen Newroz yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Newroz reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Newroz reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Newroz needs a one-time install',
    ...
    settingUpTitle: 'Setting up Newroz Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Newroz CLI or desktop instance is running. Stop any running Newroz instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Newroz Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Newroz is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Newroz…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Newroz',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Newroz at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Newroz connects automatically',
    ...
    authorizeThere: 'Authorize Newroz there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Newroz there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Newroz Desktop v${version}`,
      ...
      gatewayTitle: 'Newroz inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Newroz will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Newroz is restarting...',
      askRestart: 'Ask Newroz to restart the server',
      lookingRestart: taskId => `Newroz is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Newroz is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Newroz finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Newroz could not restart the server.',
      stillWorking:
        'Newroz is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Newroz is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Newroz gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.newroz/config.yaml). Newroz won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Newroz needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Newroz needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Newroz Desktop to use Save Image.',
    restartToSaveImages: 'Restart Newroz Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `newroz gateway` running?'
    }
  },
