...
describe('preprocessMarkdown', () => {
  ...
  it('does not swallow trailing emphasis asterisks into an autolinked url', () => {
    const input = '**PR opened: https://github.com/newroz-agent/newroz-agent/pull/12345**'
    ...
    expect(output).toContain('<https://github.com/newroz-agent/newroz-agent/pull/12345>')
