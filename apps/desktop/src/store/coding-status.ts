...
import type { NewrozGitWorktree, NewrozRepoStatus } from '@/global'
...
export const $repoStatus = atom<NewrozRepoStatus | null>(null)
...
export const $repoWorktrees = atom<NewrozGitWorktree[]>([])
