...
export interface PetInfo {
  ...
  // the Newroz "run" activity state uses the in-place running row).
 ...
 * NEWROZ_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'newroz.desktop.pet-roam.v1'
