...
import { getNewrozConfigRecord, listAllProfileSessions } from '@/newroz'
...
// Newroz session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
      ...
      ...branchGroup,
      {
        ...
        items: [
          ...
          },
          {
            icon: Download,
            id: 'cc-update-newroz',
            keywords: ['update', 'upgrade', 'newroz', 'version', 'system', 'restart'],
            label: cc.updateNewroz,
