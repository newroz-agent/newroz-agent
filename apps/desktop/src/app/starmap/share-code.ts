...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/newroz'
...
const VERSION = 3
const PREFIX = 'HML' // "Newroz Memory Loadout" — namespaces our codes like WoW's leading bytes.
