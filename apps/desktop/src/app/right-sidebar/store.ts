...
const TAKEOVER_KEY = 'newroz.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Newroz can't clear via the API — the user
 *  sees exactly what runs instead of Newroz silently deleting their creds. */
