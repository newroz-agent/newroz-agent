import type { NewrozReviewFile } from '@/global'
...
export function buildReviewFlatList(files: NewrozReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: NewrozReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
