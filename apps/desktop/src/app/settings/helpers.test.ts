...
describe('settings helpers', () => {
  ...
  it('reads and writes nested config paths', () => {
    const config: NewrozConfigRecord = { display: { theme: 'mono' } }
  ...
  it('rejects prototype-polluting config paths', () => {
    const config: NewrozConfigRecord = {}
  ...
  describe('providerGroup', () => {
    ...
    it('prefers the longest matching prefix so CN/regional buckets win', () => {
      ...
      // NEWROZ_QWEN_ shares the NEWROZ_ stem with other integrations.
      expect(providerGroup('NEWROZ_QWEN_BASE_URL')).toBe('DashScope (Qwen)')
