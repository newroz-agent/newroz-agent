...
import type { NewrozConfigRecord, ToolsetInfo } from '@/types/newroz'
...
export function getNested(obj: NewrozConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: NewrozConfigRecord, path: string, value: unknown): NewrozConfigRecord {
...
function personalityOptions(config: NewrozConfigRecord): string[] {
