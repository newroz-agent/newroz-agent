...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/newroz'
...
// / Program Files), which buried any files Newroz wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.newrozDesktop` is
    ...
    const settings = window.newrozDesktop?.settings
