...
const FOCUS_EVENT = 'newroz:composer-focus'
const INSERT_EVENT = 'newroz:composer-insert'
const INSERT_REFS_EVENT = 'newroz:composer-insert-refs'
const SUBMIT_EVENT = 'newroz:composer-submit'
const VOICE_TOGGLE_EVENT = 'newroz:composer-voice-toggle'
