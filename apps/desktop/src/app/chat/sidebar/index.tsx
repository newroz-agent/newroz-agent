...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/newroz'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('newroz:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('newroz:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Newroz to
