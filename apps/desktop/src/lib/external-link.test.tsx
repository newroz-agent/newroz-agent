...
const desktopWindow = window as unknown as { newrozDesktop?: Window['newrozDesktop'] }
const initialNewrozDesktop = desktopWindow.newrozDesktop

function installDesktopBridge(partial: Partial<Window['newrozDesktop']> = {}) {
  desktopWindow.newrozDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['newrozDesktop']
}
...
afterEach(() => {
  ...
  if (initialNewrozDesktop) {
    desktopWindow.newrozDesktop = initialNewrozDesktop
  } else {
    delete desktopWindow.newrozDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['newrozDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['newrozDesktop']['openExternal'] })
