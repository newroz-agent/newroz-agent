# nix/web.nix — Newroz Web Dashboard (Vite/React) frontend build
{ pkgs, newrozNpmLib, ... }:
let
  npm = newrozNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "newroz-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../newroz_cli/web_dist for the
