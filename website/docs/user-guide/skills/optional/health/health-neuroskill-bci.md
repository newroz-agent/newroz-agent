...
| | |
|---|---|
| Source | Optional — install with `newroz skills install official/health/neuroskill-bci` |
...
Connect Newroz to a running [NeuroSkill](https://neuroskill.com/) instance to read
