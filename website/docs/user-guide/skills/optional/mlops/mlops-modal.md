...
| | |
|---|---|
| Source | Optional — install with `newroz skills install official/mlops/modal` |
...
- **[Advanced Usage](https://github.com/newroz-agent/newroz-agent/blob/main/optional-skills/mlops/modal/references/advanced-usage.md)** - Multi-GPU, distributed training, cost optimization
- **[Troubleshooting](https://github.com/newroz-agent/newroz-agent/blob/main/optional-skills/mlops/modal/references/troubleshooting.md)** - Common issues and solutions
