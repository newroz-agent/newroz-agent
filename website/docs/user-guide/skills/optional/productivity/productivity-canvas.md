...
| | |
|---|---|
| Source | Optional — install with `newroz skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Newroz Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${NEWROZ_HOME:-~/.newroz}/.env`:
