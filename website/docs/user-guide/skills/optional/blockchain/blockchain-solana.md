...
| | |
|---|---|
| Source | Optional — install with `newroz skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain/solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Newroz Agent |
| License | MIT |
...
Helper script path: ~/.newroz/skills/blockchain/solana/scripts/solana_client.py
