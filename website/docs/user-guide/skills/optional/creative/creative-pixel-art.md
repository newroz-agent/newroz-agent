...
| | |
|---|---|
| Source | Optional — install with `newroz skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.newroz/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.newroz/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Newroz installs package this)
