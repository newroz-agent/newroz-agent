...
| | |
|---|---|
| Source | Optional — install with `newroz skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Newroz Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $NEWROZ_OSINT_CACHE/icij/ (default: ~/.cache/newroz-osint/icij/).
...
# Set NEWROZ_OSINT_UA=your-app/1.0 (your@email) to identify yourself
