...
| | |
|---|---|
| Source | Optional — install with `newroz skills install official/research/qmd` |
...
Newroz Agent via the native MCP client. This is the preferred
...
Then configure Newroz Agent to connect via HTTP:
