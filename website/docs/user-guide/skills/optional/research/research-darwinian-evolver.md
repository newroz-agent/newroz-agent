...
| | |
|---|---|
| Source | Optional — install with `newroz skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Newroz Agent |
| License | MIT |
...
import upstream classes into Newroz itself.
...
Open `~/.newroz/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Newroz core.
   Custom driver scripts under `~/.newroz/skills/...` are user-side and fine.
