...
- User wants **Newroz itself to drive a browser** → use Newroz' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
