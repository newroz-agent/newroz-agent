...
| Related skills | `native-mcp`, [`ascii-video`](/docs/user-guide/skills/bundled/creative/creative-ascii-video), [`manim-video`](/docs/user-guide/skills/bundled/creative/creative-manim-video), `newroz-video` |
...
3. Add `twozero_td` MCP server to Newroz config (if missing)
...
3. **Restart Newroz session** to pick up the new MCP server
