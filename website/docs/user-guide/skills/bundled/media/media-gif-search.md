...
Set your Tenor API key in your environment (add to `${NEWROZ_HOME:-~/.newroz}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/newroz-agent/newroz-agent/blob/main/skills/media/gif-search/url)`
