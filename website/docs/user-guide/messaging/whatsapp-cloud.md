...
Message-template support (the workaround for outside-window sends) is not yet implemented in Newroz. If you need it, please [open an issue](https://github.com/newroz-agent/newroz-agent/issues) — it's planned but waiting on a clear demand signal.
