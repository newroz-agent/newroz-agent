...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Newroz Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Newroz Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Newroz core? Start with [Build a Newroz Plugin](../developer-guide/plugins/index.md)
- Building a new built-in core tool for Newroz itself? Start with [Adding Tools](./adding-tools.md)
