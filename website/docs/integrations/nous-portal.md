...
If a model is genuinely missing, [open an issue](https://github.com/newroz-agent/newroz-agent/issues) — we surface the Portal's catalog to Newroz and gaps usually mean a routing config we can update.
