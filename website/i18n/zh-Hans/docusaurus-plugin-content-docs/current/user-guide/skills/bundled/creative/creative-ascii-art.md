...
```bash
python3 -m pyfiglet "NEWROZ" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=NEWROZ&font=Slant" | boxes -d stone
```
