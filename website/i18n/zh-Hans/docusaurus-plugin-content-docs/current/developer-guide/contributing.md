...
- **Profile 安全路径**：不得硬编码 `~/.newroz` — 代码路径使用 `newroz_constants` 中的 `get_newroz_home()`，面向用户的消息使用 `display_newroz_home()`。完整规则参见 [AGENTS.md](https://github.com/NousResearch/hermes-agent/blob/main/AGENTS.md#profiles-multi-instance-support)。
