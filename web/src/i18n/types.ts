...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateNewroz: string;
    updateNewrozConfirmMessage?: string;
    updateNewrozConfirmNow?: string;
    updateNewrozConfirmTitle?: string;
    updatingNewroz: string;
  ...
  // ── Achievements plugin (plugins/newroz-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
