...
const STORAGE_KEY = "newroz-dashboard-theme";
...
const FONT_STORAGE_KEY = "newroz-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `newroz_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "newroz-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-newroz-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-newroz-theme-font", "true");
