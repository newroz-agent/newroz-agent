 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `newroz_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Newroz Teal",
  description: "Classic dark teal — the canonical Newroz look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Newroz Teal (Large)",
  description: "Newroz Teal with bigger fonts and roomier spacing",
