 ...
 *
 * Values mirror newroz_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Newroz default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Newroz' default when unset). */
