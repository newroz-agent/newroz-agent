 ...
 *
 * Plugins call window.__NEWROZ_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__NEWROZ_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__NEWROZ_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__NEWROZ_PLUGIN_SDK__ = {
    ...
    // window.__NEWROZ_SESSION_TOKEN__ directly.
    authedFetch,
