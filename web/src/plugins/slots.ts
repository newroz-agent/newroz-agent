 ...
 * `window.__NEWROZ_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Newroz brand in the top bar
 ...
 *  `window.__NEWROZ_PLUGINS__.registerSlot(...)`.
 *
