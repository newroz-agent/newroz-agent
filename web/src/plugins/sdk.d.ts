/**
 * Newroz Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__NEWROZ_PLUGIN_SDK__`` and
 * ``window.__NEWROZ_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__NEWROZ_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``NewrozPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@newroz/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__NEWROZ_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__NEWROZ_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__NEWROZ_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface NewrozPluginSDK {
...
declare global {
  interface Window {
    __NEWROZ_PLUGIN_SDK__?: NewrozPluginSDK;
    __NEWROZ_PLUGINS__?: PluginRegistry;
  }
}
