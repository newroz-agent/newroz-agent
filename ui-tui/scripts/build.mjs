...
await build({
  ...
  // Skip the prebuilt @newroz/ink bundle and inline the source instead:
  ...
  alias: { '@newroz/ink': resolve(root, 'packages/newroz-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The newroz_cli launcher
