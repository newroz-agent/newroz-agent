import { Box, Text, useStdout } from '@newroz/ink'
...
const TAG_FULL = 'Newroz · The self-improving AI agent'
const TAG_MID = 'The self-improving AI agent'
const TAG_TINY = 'Newroz'
const HIDE_BELOW = 34
...
export function SessionPanel({ info, maxWidth, sid, t }: SessionPanelProps) {
  ...
  // newroz_cli/banner.py) and the "connected" label on the collapse toggle.
      ...
      {wide && (
        <Box flexDirection="column" marginRight={2} width={leftW}>
          ...
          <Text color={t.color.accent}>
            ...
            <Text color={t.color.muted}> · Newroz</Text>
          </Text>
      ...
      <Box flexDirection="column" width={w}>
        ...
        {typeof info.update_behind === 'number' && info.update_behind > 0 && (
          <Text bold color={t.color.warn}>
            ...
            <Text bold color={t.color.warn}>
              {info.update_command || 'newroz update'}
            </Text>
            <Text bold={false} color={t.color.warn} dimColor>
              {' '}
              to update
