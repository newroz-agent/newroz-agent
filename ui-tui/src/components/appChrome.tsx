import { Box, type ScrollBoxHandle, stringWidth, Text } from '@newroz/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (NEWROZ_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (NEWROZ_DEV_CREDITS), lowest priority,
