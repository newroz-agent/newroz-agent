 ...
 *
 * Symptom: in `newroz --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@newroz/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using newroz --tui and as i type multiline my caret at the end will often ' +
