...
import type { ScrollBoxHandle } from '@newroz/ink'
import { evictInkCaches } from '@newroz/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.NEWROZ_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
