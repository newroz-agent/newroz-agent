"""``newroz tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'newroz tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # newroz tools list [--platform cli]
    ...
    # newroz tools disable <name...> [--platform cli]
    ...
    # newroz tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `newroz tools` runs after you pick a provider that\n"
