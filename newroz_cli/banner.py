...
# Layered flame in the Newroz fire palette (red → orange → gold, bright core).
# 15 lines × 30 cells — same footprint as the old caduceus so the info lines
# below it keep their position. Colors are Rich hex markup, so Rich downgrades
# truecolor → 256 → 16-color → plain automatically on lesser terminals.
NEWROZ_FLAME = """⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀[#7A1F1F]⢰⣄[/]⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀[#7A1F1F]⢀[/][#A8291C]⣿[/][#7A1F1F]⣿⣦⡀[/][#E2452B]⠠⡄[/]⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀[#A8291C]⠆[/]⠀⠀⠀[#7A1F1F]⢠[/][#A8291C]⣾[/][#C93222]⣿[/][#A8291C]⣿⣿[/][#7A1F1F]⣷⡄[/]⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀[#7A1F1F]⢀⣴[/][#A8291C]⣿[/][#C93222]⣿⣿⣿[/][#A8291C]⣿⣿[/][#7A1F1F]⣷[/]⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀[#7A1F1F]⢀⣴[/][#A8291C]⣿⣿[/][#C93222]⣿[/][#E2452B]⣿⣿[/][#C93222]⣿⣿[/][#A8291C]⣿⣿[/][#7A1F1F]⡇[/]⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀[#7A1F1F]⢀⣴[/][#A8291C]⣿⣿[/][#C93222]⣿⣿[/][#E2452B]⣿⣿⣿⣿[/][#C93222]⣿⣿[/][#A8291C]⣿[/][#7A1F1F]⣧[/]⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀[#7A1F1F]⣰[/][#A8291C]⣿⣿[/][#C93222]⣿⣿[/][#E2452B]⣿⣿[/][#F59E1B]⣿⣿⣿[/][#E2452B]⣿⣿[/][#C93222]⣿[/][#A8291C]⣿[/][#7A1F1F]⣿[/]⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀[#7A1F1F]⢀⣾[/][#A8291C]⣿⣿[/][#C93222]⣿⣿[/][#E2452B]⣿⣿[/][#F59E1B]⣿⣿[/][#FFBF00]⣿[/][#F59E1B]⣿⣿[/][#E2452B]⣿[/][#C93222]⣿⣿[/][#7A1F1F]⣿[/]⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀[#7A1F1F]⢀⣾[/][#A8291C]⣿[/][#C93222]⣿⣿[/][#E2452B]⣿⣿[/][#F59E1B]⣿⣿[/][#FFBF00]⣿⣿⣿[/][#F59E1B]⣿⣿[/][#E2452B]⣿⣿[/][#C93222]⣿[/][#A8291C]⣿[/][#7A1F1F]⡀[/]⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀[#7A1F1F]⣸[/][#A8291C]⣿[/][#C93222]⣿⣿[/][#E2452B]⣿⣿[/][#F59E1B]⣿⣿[/][#FFBF00]⣿⣿[/][#FFD700]⣿[/][#FFBF00]⣿⣿[/][#F59E1B]⣿⣿[/][#E2452B]⣿[/][#C93222]⣿[/][#A8291C]⣿[/][#7A1F1F]⡇[/]⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀[#7A1F1F]⣿[/][#A8291C]⣿[/][#C93222]⣿[/][#E2452B]⣿⣿[/][#F59E1B]⣿⣿[/][#FFBF00]⣿⣿[/][#FFD700]⣿⣿⣿[/][#FFBF00]⣿[/][#F59E1B]⣿⣿[/][#E2452B]⣿[/][#C93222]⣿[/][#A8291C]⣿[/][#7A1F1F]⡇[/]⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀[#7A1F1F]⢹[/][#A8291C]⣿[/][#C93222]⣿[/][#E2452B]⣿[/][#F59E1B]⣿⣿[/][#FFBF00]⣿⣿[/][#FFD700]⣿[/][#FFD966]⣿⣿[/][#FFD700]⣿⣿[/][#FFBF00]⣿[/][#F59E1B]⣿[/][#E2452B]⣿[/][#C93222]⣿[/][#A8291C]⣿[/][#7A1F1F]⡇[/]⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀[#7A1F1F]⠈[/][#A8291C]⢿[/][#C93222]⣿[/][#E2452B]⣿[/][#F59E1B]⣿⣿[/][#FFBF00]⣿[/][#FFD700]⣿[/][#FFD966]⣿⣿⣿⣿[/][#FFD700]⣿[/][#FFBF00]⣿[/][#F59E1B]⣿[/][#E2452B]⣿[/][#C93222]⣿[/][#A8291C]⣿[/][#7A1F1F]⡇[/]⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀[#7A1F1F]⠈[/][#A8291C]⢿[/][#C93222]⣿[/][#E2452B]⣿[/][#F59E1B]⣿[/][#FFBF00]⣿[/][#FFD700]⣿[/][#FFD966]⣿⣿⣿⣿[/][#FFD700]⣿[/][#FFBF00]⣿[/][#F59E1B]⣿[/][#E2452B]⣿[/][#C93222]⣿[/][#A8291C]⡟[/]⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀[#A8291C]⠙[/][#C93222]⢿[/][#F59E1B]⣿[/][#FFBF00]⣿[/][#FFD700]⣿[/][#FFD966]⣿⣿⣿⣿[/][#FFD700]⣿[/][#FFBF00]⣿[/][#F59E1B]⣿[/][#C93222]⡿[/][#A8291C]⠋[/]⠀⠀⠀⠀⠀⠀⠀⠀"""

# Back-compat alias — skins and downstream forks referenced the old name.
NEWROZ_CADUCEUS = NEWROZ_FLAME
...
_UPSTREAM_REPO_URL = "https://github.com/newroz-agent/newroz-agent.git"
...
_RELEASE_URL_BASE = "https://github.com/newroz-agent/newroz-agent/releases/tag"
...
def get_latest_release_tag(repo_dir: Optional[Path] = None) -> Optional[tuple]:
    ...
    canonical newroz-agent/newroz-agent repo (forks don't get a link).
    """
...
def build_welcome_banner(console: "Console", model: str, cwd: str,
    ...
    try:
        ...
        _hero = _bskin.banner_hero if hasattr(_bskin, 'banner_hero') and _bskin.banner_hero else NEWROZ_FLAME
    except Exception:
        _bskin = None
        _hero = NEWROZ_FLAME
    left_lines = ["", _hero, ""]
    if (provider or "").strip().lower() == "moa":
        ...
        left_lines.append(f"[{accent}]MoA: {preset_name}[/]{agg_str}{ctx_str} [dim {dim}]·[/] [dim {dim}]Newroz[/]")
    else:
        ...
        ctx_str = f" [dim {dim}]·[/] [dim {dim}]{_format_context_length(context_length)} context[/]" if context_length else ""
        left_lines.append(f"[{accent}]{model_short}[/]{ctx_str} [dim {dim}]·[/] [dim {dim}]Newroz[/]")
