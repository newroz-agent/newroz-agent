...
def _perform_uninstall(
    *,
    ...
    if not full_uninstall:
        ...
        if _is_windows():
            print(color("  iex (irm https://newroz-agent.vercel.app/install.ps1)", Colors.DIM))
        else:
            print(color("  curl -fsSL https://newroz-agent.vercel.app/install.sh | bash", Colors.DIM))
        print()
