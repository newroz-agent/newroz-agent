...
Hooks are discovered from ~/.newroz/hooks/ directories, each containing:
...
HOOKS_DIR = get_newroz_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"newroz_hook_{hook_name}"
