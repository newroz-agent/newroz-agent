...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$NEWROZ_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_newroz_dir("platforms/whatsapp/session", "whatsapp/session")
