...
(``~/.newroz/plans/god-file-decomposition.md``, Phase 3 mechanical mixin lifts).
...
class GatewayAuthorizationMixin:
    ...
    def _adapter_group_has_sender_allowlist(
        ...
        *,
        ...
        restricting which senders inside that group can invoke Newroz. If such a
    ...
    def _is_user_authorized(self, source: SessionSource) -> bool:
        ...
        # (newroz gateway pairing approve / the authenticated dashboard) — an
