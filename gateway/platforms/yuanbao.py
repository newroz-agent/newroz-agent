...
try:
    ...
    _NEWROZ_VERSION = "0.0.0"

_APP_VERSION = _NEWROZ_VERSION
_BOT_VERSION = _NEWROZ_VERSION
_YUANBAO_INSTANCE_ID = str(NEWROZ_INSTANCE_ID)  # single source: yuanbao_proto.NEWROZ_INSTANCE_ID
