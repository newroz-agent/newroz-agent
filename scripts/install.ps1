...
#
# Usage:
#   iex (irm https://newroz-agent.nousresearch.com/install.ps1)
#
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://newroz-agent.nousresearch.com/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
