#!/usr/bin/env python3
"""Build the Newroz Skills Index — a centralized JSON catalog of all skills.
...
`newroz skills search/install` can use it without hitting the GitHub API.
...
# Ensure NEWROZ_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Newroz Skills Index...", flush=True)
