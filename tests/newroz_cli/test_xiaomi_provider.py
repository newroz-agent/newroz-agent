...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from newroz_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in NEWROZ_OVERLAYS
        overlay = NEWROZ_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify newroz doctor recognizes Xiaomi env vars."""
