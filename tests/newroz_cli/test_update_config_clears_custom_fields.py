"""Tests for newroz_cli.auth._update_config_for_provider clearing stale fields.
...
from newroz_cli.config import clear_model_endpoint_credentials, get_config_path
