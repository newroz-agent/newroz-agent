...
def worker_loop(worker_id: int, newroz_home: str, result_file: str) -> None:
...
def reclaimer_loop(newroz_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="newroz_mixed_stress_")
    print(f"NEWROZ_HOME = {home}")
