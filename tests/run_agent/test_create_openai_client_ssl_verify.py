...
_CA_ENV_VARS = ("NEWROZ_CA_BUNDLE", "SSL_CERT_FILE", "REQUESTS_CA_BUNDLE", "HTTPS_PROXY")
...
def test_build_keepalive_http_client_uses_newroz_ca_bundle(clean_tls_env, monkeypatch):
