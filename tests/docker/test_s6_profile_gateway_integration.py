...
The unit tests in tests/newroz_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned newroz-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/newroz")
from newroz_cli.service_manager import S6ServiceManager
