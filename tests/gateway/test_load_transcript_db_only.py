...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.newroz/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at newroz_state import time, before pytest's NEWROZ_HOME monkeypatch
    fires — the autouse fixture's NEWROZ_HOME override doesn't help here.)
    """
    import newroz_state
