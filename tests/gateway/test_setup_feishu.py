"""Tests for _setup_feishu() in newroz_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("newroz_cli.config.save_env_value", side_effect=mock_save), \
         patch("newroz_cli.config.get_env_value", side_effect=mock_get), \
         patch("newroz_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("newroz_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("newroz_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("newroz_cli.cli_output.print_header"), \
         patch("newroz_cli.cli_output.print_info"), \
         patch("newroz_cli.cli_output.print_success"), \
         patch("newroz_cli.cli_output.print_warning"), \
         patch("newroz_cli.cli_output.print_error"), \
