...
thinking phase.  Newroz's default cloud-stream stale detector
(``NEWROZ_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``NEWROZ_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
