...
to a generic "Your API key was rejected... run newroz setup" message, which is
...
def test_nous_401_guidance_strings_present():
    ...
    # Must give a concrete re-auth command, not a generic "newroz setup".
    assert "newroz portal" in source
