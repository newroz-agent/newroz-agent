#!/usr/bin/env python3
"""
SWE Runner with Newroz Trajectory Format

A runner that uses Newroz-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Newroz-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Newroz-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Newroz format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Newroz-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Newroz-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Newroz Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Newroz-Agent's built-in execution environments
    and outputs trajectories in Newroz-Agent format.
    """
    ...
    def _convert_to_newroz_format(
        ...
        """
        Convert internal message format to Newroz trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Newroz trajectory format
        trajectory = self._convert_to_newroz_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Newroz trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Newroz Trajectory Format")
    print("=" * 60)
