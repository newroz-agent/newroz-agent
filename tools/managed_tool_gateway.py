...
def auth_json_path():
    """Return the Newroz auth store path, respecting NEWROZ_HOME overrides."""
    return get_newroz_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`newroz tools`, banner/status paint, provider
