...
(3 SDK retries x 3 Newroz retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_newroz_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".newroz")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Newroz, ...) behind one endpoint.  A 429 can mean either:
