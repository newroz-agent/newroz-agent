"""Vertex AI (Google Cloud) adapter for Newroz Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Newroz to use Gemini models via Google Cloud with
...
# who installed plain `newroz-agent` and only later selected a Gemini model.
try:
