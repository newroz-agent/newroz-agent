...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Newroz's web-provider config and
        ...
        # native search engine for xAI sessions instead of Newroz's
        # configured web provider (Tavily/etc.), and those results bypass
        # Newroz's tool-trace / citation plumbing (they arrive baked into the
