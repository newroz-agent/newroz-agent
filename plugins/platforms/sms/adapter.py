...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Newroz gateway adapter.

    Each inbound phone number gets its own Newroz session (multi-tenant).
...
# static dict in newroz_cli/gateway.py, and the _send_sms dispatch in
