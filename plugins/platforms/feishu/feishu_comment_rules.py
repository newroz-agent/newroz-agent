...
Config: ~/.newroz/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.newroz/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_newroz_home()`` helper (NEWROZ_HOME-aware and
...
RULES_FILE = get_newroz_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_newroz_home() / "feishu_comment_pairing.json"
