# Newroz Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.newroz/plugins/newroz-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.newroz/plugins/newroz-achievements/scan_checkpoint.json`.
