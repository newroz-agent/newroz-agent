...
def get_newroz_home() -> Path:
    ...
    ``newroz_cli/kanban_db.py``).  See https://github.com/newroz-agent/newroz-agent/issues/18594.
    """
...
def secure_parent_dir(path: Path) -> None:
    ...
    See https://github.com/newroz-agent/newroz-agent/issues/25821.
    """
...
def is_container() -> bool:
    ...
    See: newroz-agent/newroz-agent#47111
    """
