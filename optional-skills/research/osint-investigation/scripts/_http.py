...
DEFAULT_UA = (
    "newroz-osint-investigation/0.2 "
    "(+https://github.com/NousResearch/hermes-agent; "
    "set NEWROZ_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("NEWROZ_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
