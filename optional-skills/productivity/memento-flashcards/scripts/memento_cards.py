...
Data file: $NEWROZ_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_NEWROZ_HOME = Path(os.environ.get("NEWROZ_HOME", Path.home() / ".newroz"))
DATA_DIR = _NEWROZ_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
